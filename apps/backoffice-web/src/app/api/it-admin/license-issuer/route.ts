...
import { isOfflineLicenseSignerConfigured, issueOfflineLicense, type IssueOfflineLicenseInput } from "@/lib/offline-license-issuer";
...
export async function GET() {
  try {
    ...
    return ok({
      configured: isOfflineLicenseSignerConfigured(),
